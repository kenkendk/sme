...
In the current version of SME we focus mostly on the modelling and code-generation capabilities, so you need to use the vendor tools to set timing constraints and pin assignments for your circuit.
